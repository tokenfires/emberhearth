...
- **Language:** Swift 6.2 + SwiftUI (native macOS)
- **Build system:** Xcode project at `EmberHearth/EmberHearth.xcodeproj` (generated by [XcodeGen](https://github.com/yonaskolb/XcodeGen) from `EmberHearth/project.yml`)
...
```bash
# Generate/regenerate Xcode project (after editing project.yml)
cd EmberHearth && xcodegen generate

# Build
xcodebuild -project EmberHearth/EmberHearth.xcodeproj -scheme EmberHearth build

# Test
xcodebuild -project EmberHearth/EmberHearth.xcodeproj -scheme EmberHearth test

# Or open in Xcode
open EmberHearth/EmberHearth.xcodeproj
```
